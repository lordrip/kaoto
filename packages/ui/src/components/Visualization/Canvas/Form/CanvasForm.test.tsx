...
describe('CanvasForm', () => {
  ...
  describe('should show the User-updated field under the modified tab', () => {
    ...
    it('normal text field', async () => {
      ...
      let variableReceiveField = formPageObject.getFormField('Variable Receive');
      expect(variableReceiveField).not.toBeInTheDocument();

      await formPageObject.showAllFields();
      variableReceiveField = formPageObject.getFormField('Variable Receive');
    ...
    it('expression field', async () => {
      ...
      let inputExpression = formPageObject.getFormField('Expression');
      ...
      inputExpression = formPageObject.getFormField('Expression');
      expect(inputExpression).toBeInTheDocument();
    });
    ...
    it('dataformat field', async () => {
      ...
      await formPageObject.setObjectForProperty(`${ROOT_PATH}.barcode`);

      let inputBarcodeFormat = formPageObject.getFormField('Barcode Format');
      ...
      inputBarcodeFormat = formPageObject.getFormField('Barcode Format');
      expect(inputBarcodeFormat).toBeInTheDocument();
    ...
    it('loadbalancer field', async () => {
      ...
      await formPageObject.setObjectForProperty(`${ROOT_PATH}.failoverLoadBalancer`);

      let inputRoundRobin = formPageObject.getFormField('Round Robin');
      ...
      inputRoundRobin = formPageObject.getFormField('Round Robin');
      expect(inputRoundRobin).toBeInTheDocument();
  ...
  describe('should show the Required field under the required tab', () => {
    ...
    it('normal text field', async () => {
      ...
      let timerNameField = formPageObject.getFormField('Timer Name');
      expect(timerNameField).toBeInTheDocument();

      await formPageObject.inputText('Timer Name', 'quartz');

      await formPageObject.showAllFields();
      timerNameField = formPageObject.getFormField('Timer Name');
      expect(timerNameField).toBeInTheDocument();
    ...
    it('dataformat field', async () => {
      ...
      await formPageObject.setObjectForProperty(`${ROOT_PATH}.beanio`);
      let inputBarcodeFormat = formPageObject.getFormField('Mapping');
      expect(inputBarcodeFormat).toBeInTheDocument();
      ...
      inputBarcodeFormat = formPageObject.getFormField('Mapping');
      expect(inputBarcodeFormat).toBeInTheDocument();
    ...
    it('loadbalancer field', async () => {
      ...
      await formPageObject.setObjectForProperty(`${ROOT_PATH}.weightedLoadBalancer`);
      let inputDistributionRatio = formPageObject.getFormField('Distribution Ratio');
      ...
      inputDistributionRatio = formPageObject.getFormField('Distribution Ratio');
      expect(inputDistributionRatio).toBeInTheDocument();
