...
const mockUseDeleteGroup = useDeleteGroup as vi.MockedFunction<typeof useDeleteGroup>;
const mockUseDeleteStep = useDeleteStep as vi.MockedFunction<typeof useDeleteStep>;
const mockUseDisableStep = useDisableStep as vi.MockedFunction<typeof useDisableStep>;
const mockUseDuplicateStep = useDuplicateStep as vi.MockedFunction<typeof useDuplicateStep>;
const mockUseMoveStep = useMoveStep as vi.MockedFunction<typeof useMoveStep>;
const mockUseEnableAllSteps = useEnableAllSteps as vi.MockedFunction<typeof useEnableAllSteps>;
const mockUseInsertStep = useInsertStep as vi.MockedFunction<typeof useInsertStep>;
const mockUseReplaceStep = useReplaceStep as vi.MockedFunction<typeof useReplaceStep>;
